 ...
 * @param author - Review author (should be 'coderabbitai')
 * @param authorAssociation - Author association
 * @param isBot - Whether author is a bot
 * @param options - CodeRabbit-specific parsing options
 * @param includeStatusIndicators - Whether to include status indicators
 * @returns Array of parsed actionable comments from CodeRabbit
 */
