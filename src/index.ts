    ...
    tools: [
      {
        ...
        description:
          "Analyze PR CI failures and provide targeted fix instructions. 💾 Preference hints: bail_on_first",
        inputSchema: {
          type: "object",
          properties: {
            pr: {
            ...
            bail_on_first: {
              type: "boolean",
              description:
                "💾 Stop at first failure when waiting (default: true). User preference: fast feedback vs complete results",
              default: true,
            },
            cursor: {
              type: "string",
      ...
      },
      {
        ...
        description:
          "Find unresolved PR comments. Returns raw data for LLM analysis. 💾 Preference hints: include_bots, sort",
        inputSchema: {
          type: "object",
          properties: {
            pr: {
            ...
            coderabbit_options: {
              ...
              properties: {
                ...
                extract_agent_prompts: {
                  type: "boolean",
                  description:
                    "💾 Generate agent-friendly prompts (default: true). User preference: AI agent optimization. When enabled, CodeRabbit comments return only the AI agent prompt in the body field instead of full comment text.",
                  default: true,
                },
              },
            },
      ...
      },
      {
        ...
        description:
          "Manage stacked PRs with rebase automation. Detects squash-merges and recommends --onto strategy. 💾 Preference hint: auto_fix",
        inputSchema: {
          type: "object",
          properties: {
            base_pr: {
            ...
            auto_fix: {
              type: "boolean",
              description:
                "💾 Auto-fix test failures (default: true). User preference: trust level",
              default: true,
            },
            use_onto: {
              type: "boolean",
              description:
                "Use --onto for rebase (default: auto-detect based on squash-merge)",
            },
            onto_base: {
              type: "string",
        ...
        inputSchema: {
          ...
          properties: {
            ...
            target_branch: {
              type: "string",
              description:
                "Target branch to check conflicts against (optional)",
            },
          },
          required: ["pr"],
        },
      ...
      },
      {
        ...
        description:
          "Generate rebase commands after upstream PR was squash-merged, using --onto strategy",
        inputSchema: {
          type: "object",
          properties: {
            pr: {
            ...
            upstream_pr: {
              type: "string",
              description:
                "Upstream PR that was squash-merged (optional, can auto-detect)",
            },
            target_branch: {
              type: "string",
      ...
      },
      {
        ...
        description:
          "Resolve a specific review thread (or via comment id) immediately",
        inputSchema: {
          type: "object",
          properties: {
            pr: {
            ...
            prefer: {
              type: "string",
              description:
                'Prefer "thread" or "comment" when both are provided',
              enum: ["thread", "comment"],
              default: "thread",
            },
          },
