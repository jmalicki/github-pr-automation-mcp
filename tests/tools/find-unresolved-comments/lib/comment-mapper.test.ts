...
import { mapReviewComments, mapIssueComments } from '../../../../src/tools/find-unresolved-comments/lib/comment-mapper.js';
      ...
      const mockReviewComments = [
        {
          ...
          line: 15,
          body: 'Bot suggestion',
          html_url: 'https://github.com/test-owner/test-repo/pull/123#discussion_r2',
      ...
      const mockReviewComments = [
        {
          ...
          line: null,
          body: null,
          html_url: 'https://github.com/test-owner/test-repo/pull/123#discussion_r3',
          reactions: null
        }
      ];
      ...
      const mockReviewComments = [
        {
          ...
          in_reply_to_id: 1,
          html_url: 'https://github.com/test-owner/test-repo/pull/123#discussion_r4',
          reactions: { total_count: 0, '+1': 0, '-1': 0, laugh: 0, hooray: 0, confused: 0, heart: 0, rocket: 0, eyes: 0 }
        }
      ];
      ...
      const mockIssueComments = [
        {
          ...
          html_url: 'https://github.com/test-owner/test-repo/issues/123#issuecomment-5',
          reactions: {
            total_count: 1,
            '+1': 1,
            '-1': 0,
      ...
      const mockIssueComments = [
        {
          ...
          html_url: 'https://github.com/test-owner/test-repo/issues/123#issuecomment-6',
          reactions: { total_count: 0, '+1': 0, '-1': 0, laugh: 0, hooray: 0, confused: 0, heart: 0, rocket: 0, eyes: 0 }
        }
      ];
      ...
      const mockIssueComments = [
        {
          ...
          body: null,
          html_url: 'https://github.com/test-owner/test-repo/issues/123#issuecomment-7',
          reactions: null
        }
      ];
