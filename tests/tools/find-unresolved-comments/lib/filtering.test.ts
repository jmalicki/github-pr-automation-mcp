...
import { filterUnresolvedComments, applyBasicFiltering, sortComments } from '../../../../src/tools/find-unresolved-comments/lib/filtering.js';
...
describe('filtering', () => {
  ...
  describe('sortComments', () => {
    const createComment = (id: number, createdAt: string, filePath?: string, author?: string, priorityScore?: number): Comment => ({
      id,
