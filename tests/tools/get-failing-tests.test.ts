...
FAIL tests/another.test.ts
  AssertionError: Expected 42 but received 0
    ...
    expect(failure.error_message).toContain(
      "AssertionError: Expected 42 but received 0",
    );
  ...
  it("should paginate results correctly", async () => {
    ...
    mockOctokit.checks.listForRef
      .mockResolvedValueOnce({
        ...
        headers: {
          link: '<https://api.github.com/repos/owner/repo/commits/abc123/check-runs?page=2>; rel="next"',
        },
      })
      .mockResolvedValueOnce({
        data: {
        ...
        headers: {
          link: '<https://api.github.com/repos/owner/repo/commits/abc123/check-runs?page=3>; rel="next"',
        },
      })
      .mockResolvedValueOnce({
        data: {
